...
namespace Extensions.Runtime
{
    public static class ColorExtensions
    {
        ...
        #region RANDOM
        public static void Randomize(this Color color, Color min, Color max)
        {
            color.r = Random.Range(min.r, max.r);
            color.g = Random.Range(min.g, max.g);
            color.b = Random.Range(min.b, max.b);
            color.a = Random.Range(min.a, max.a);
        }
        
        public static Color Blank => new Color(1,1,1,1);
